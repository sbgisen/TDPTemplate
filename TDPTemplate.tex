...
\begin{figure}[tbp]
	...
	\caption{Object detection pipeline.
		YOLOv8's bounding boxes and the point cloud data are given to \text{jsk\_pcl\_ros} package to generate 3D collision boxes, circled in red, which are passed to MoveIt planning scene.}
